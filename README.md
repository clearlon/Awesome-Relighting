...
[2025.06] [NeurIPS2025] DreamLight: Towards Harmonious and Consistent Image Relighting [paper](https://arxiv.org/pdf/2506.14549) [code](https://github.com/yongliu20/DreamLight) ![GitHub Repo stars](https://img.shields.io/github/stars/yongliu20/DreamLight)       

[2025.07] [SIGGRAPH2025] Physically Controllable Relighting of Photographs [paper](https://yaksoy.github.io/papers/SIG25-PhysicalRelighting.pdf) [project](https://yaksoy.github.io/PhysicalRelighting/)     

[2025.08] Hybrelighter: Combining Deep Anisotropic Diffusion and Scene Reconstruction for On-device Real-time Relighting in Mixed Reality [paper](https://arxiv.org/pdf/2508.14930)
...
[2025.02] [ICCV2025] Light-A-Video: Training-free Video Relighting via Progressive Light Fusion [paper](https://arxiv.org/pdf/2502.08590)  [code](https://github.com/bcmi/Light-A-Video/)  ![GitHub Repo stars](https://img.shields.io/github/stars/bcmi/Light-A-Video)       
...
[2023.12] [TOG2024] RNA: Relightable Neural Assets [paper](https://arxiv.org/pdf/2312.09398)  
...
[2024.05] [NeurIPS2025] MetaGS: A Meta-Learned Gaussian-Phong Model for Out-of-Distribution 3D Scene Relighting [paper](https://arxiv.org/pdf/2405.20791)   
...
[2025.05] [SIGGRAPH2025] RenderFormer: Transformer-based Neural Rendering of Triangle Meshes with Global Illumination [paper](https://arxiv.org/pdf/2505.21925) [project](https://microsoft.github.io/renderformer/) [code](https://github.com/microsoft/renderformer) ![GitHub Repo stars](https://img.shields.io/github/stars/microsoft/renderformer)   
...
[2025.06] 2D Triangle Splatting for Direct Differentiable Mesh Training [paper](https://arxiv.org/pdf/2506.18575) 
...
[2025.06] Light of Normals: Unified Feature Representation for Universal Photometric Stereo [paper](https://arxiv.org/pdf/2506.18882) [project](https://houyuanchen111.github.io/lino.github.io/) [code](https://github.com/houyuanchen111/LINO_UniPS) ![GitHub Repo stars](https://img.shields.io/github/stars/houyuanchen111/LINO_UniPS)

[2025.06] [ICCV2025] HiNeuS: High-fidelity Neural Surface Mitigating Low-texture and Reflective Ambiguity [paper](https://arxiv.org/pdf/2506.23854)  

[2025.07] [SIGGRAPH2025] Practical Inverse Rendering of Textured and Translucent Appearance [paper](https://weiphil.s3.eu-central-1.amazonaws.com/practical_reconstruction.pdf) [project](https://dvicini.github.io/practical-inverse-rendering/)               

[2025.07] MatDecompSDF: High-Fidelity 3D Shape and PBR Material Decomposition from Multi-View Images [paper](https://arxiv.org/pdf/2507.04749)  

[2025.07] RTR-GS: 3D Gaussian Splatting for Inverse Rendering with Radiance Transfer and Reflection [paper](https://arxiv.org/pdf/2507.07733) 

[ICCV2025] LightSwitch: Multi-view Relighting with Material-guided Diffusion  

[ICCV2025] SU-RGS: Relightable 3D Gaussian Splatting from Sparse Views under Unconstrained Illuminations  

[ICCV2025] GaRe: Relightable 3D Gaussian Splatting for Outdoor Scenes from Unconstrained Photo Collections  

[ICCV2025] Gaussian Splatting with Discretized SDF for Relightable Assets  

[2025.10] [NeurIPS2025] ROGR: Relightable 3D Objects using Generative Relighting [paper](https://arxiv.org/pdf/2510.03163) [project](https://tangjiapeng.github.io/ROGR/)   
...
[2025.06] MADrive: Memory-Augmented Driving Scene Modeling [paper](https://arxiv.org/pdf/2506.21520) [project](https://yandex-research.github.io/madrive/)  
...
[ECCV2020] AIM 2020 [Any to one relighting](https://competitions.codalab.org/competitions/24671) [Illumination Settings estimation](https://competitions.codalab.org/competitions/24773) [Any to any relighting](https://competitions.codalab.org/competitions/24674)    

[CVPR2021] NTIRE 2021 Depth Guided Image Relighting [One-to-One relighting](https://competitions.codalab.org/competitions/28030) [Any-to-Any relighting](https://competitions.codalab.org/competitions/28031)   

[CVPR2025] NTIRE 2025  [Video Quality Enhancement for Video Conferencing](https://codalab.lisn.upsaclay.fr/competitions/21291)    

[ICCV2025] UniLight Workshop [link](https://unilight-workshop.github.io/unilight2025/#)     

## Software Products
Flux Kontext Relight [https://huggingface.co/spaces/kontext-community/kontext-relight](https://huggingface.co/spaces/kontext-community/kontext-relight)  
SwitchLight: [https://www.switchlight.beeble.ai/](https://www.switchlight.beeble.ai/)   
Switchlight 2.0: [https://app.beeble.ai/home](https://app.beeble.ai/home) [report](https://beeble.ai/research/switchlight-2-0-is-here)         
IC-Light: https://github.com/lllyasviel/IC-Light [https://huggingface.co/spaces/lllyasviel/IC-Light](https://huggingface.co/spaces/lllyasviel/IC-Light)  [https://huggingface.co/spaces/lllyasviel/iclight-v2-vary](https://huggingface.co/spaces/lllyasviel/iclight-v2-vary)        
LBM: [https://huggingface.co/spaces/jasperai/LBM_relighting](https://huggingface.co/spaces/jasperai/LBM_relighting)        
Adobe ProjectPerfectBlend: [https://x.com/Pinsky/status/1846351993478037857](https://x.com/Pinsky/status/1846351993478037857)   
Magnific Relight: [https://x.com/javilopen/status/1805274155065176489](https://x.com/javilopen/status/1805274155065176489)   
Clipdrop: [https://clipdrop.co/relight](https://clipdrop.co/relight)   
FreeLighting: [https://huggingface.co/spaces/wulongmetac/FreeLighting](https://huggingface.co/spaces/wulongmetac/FreeLighting)  [code](https://github.com/liuyuxuan3060/FreeLighting)    
...
[SIGGRAPH2025] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation [paper](https://arxiv.org/pdf/2408.13252) [project](https://ys-imtech.github.io/projects/LayerPano3D/) [code](https://github.com/3DTopia/LayerPano3D)  ![GitHub Repo stars](https://img.shields.io/github/stars/3DTopia/LayerPano3D)  
...
[TOG2023] Spatiotemporally Consistent HDR Indoor Lighting Estimation [paper](https://arxiv.org/pdf/2305.04374)  
...
[CVPR2024] Towards a Perceptual Evaluation Framework for Lighting Estimation [paper](https://arxiv.org/pdf/2312.04334) [project](https://lvsn.github.io/PerceptionMetric/)    

[SIGGRAPH2025] Spatiotemporally Consistent Indoor Lighting Estimation with Diffusion Priors    

[TVCG2025] IllumiDiff: Indoor Illumination Estimation from a Single Image with Diffusion Model [paper](https://graphvision.whu.edu.cn/paper/2025/ShenShiYuan_TVCG_2025.pdf) [code](https://github.com/nauyihsnehs/IllumiDiff) ![GitHub Repo stars](https://img.shields.io/github/stars/nauyihsnehs/IllumiDiff) 
